...
MACRO(SEARCH_3RDPARTY OSG_3RDPARTY_BIN)
        ...
        FIND_DEPENDENCY(JPEG jpeglib.h "libjpeg;jpeg" ${OSG_3RDPARTY_BIN}/theirs "D" "")
        FIND_DEPENDENCY(RAPIDJSON rapidjson/rapidjson.h "" ${OSG_3RDPARTY_BIN}/theirs "D" "")
        FIND_DEPENDENCY(GDAL gdal.h "gdal;gdal16" ${OSG_3RDPARTY_BIN} "d" "_i")
        FIND_DEPENDENCY(GLUT GL/glut.h glut32 ${OSG_3RDPARTY_BIN} "D" "")
        FIND_DEPENDENCY(GEOMETRY geometry/common.h "" ${OSG_3RDPARTY_BIN} "" "")
        FIND_DEPENDENCY(COMMON common/no_deduce.h "" ${OSG_3RDPARTY_BIN} "" "")
        IF(GLUT_FOUND)
        ...
        FIND_DEPENDENCY(ZLIB zlib.h "z;zlib;zlib1" ${OSG_3RDPARTY_BIN}/theirs "D" "")
        IF(ZLIB_FOUND)
            FIND_DEPENDENCY(PNG png.h "libpng;libpng13;libpng15;libpng16" ${OSG_3RDPARTY_BIN}/theirs "D" "")
            IF(PNG_FOUND)
...
IF(USE_3RDPARTY_BIN)
    ...
    SET(TEST_3RDPARTY_DIR "${PROJECT_SOURCE_DIR}/3rdparty")
